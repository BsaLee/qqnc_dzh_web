...
<template>
  <div class="space-y-4">
    <div class="rounded-lg bg-white/40 backdrop-blur-md shadow dark:bg-gray-800/40">
      ...
      <!-- Summary -->
      <div class="flex flex-wrap gap-4 border-b border-gray-100 bg-white/40 backdrop-blur-md p-4 text-sm dark:border-gray-700 dark:bg-gray-800/40">
