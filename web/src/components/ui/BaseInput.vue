  ...
  <div class="flex flex-col gap-1.5">
    ...
    <div class="relative">
      <input
        ...
        :disabled="disabled"
        class="base-input w-full border border-gray-200 rounded-lg bg-white/40 backdrop-blur-md px-3 py-2 outline-none transition-all duration-200 dark:border-gray-700 focus:border-green-500 dark:bg-gray-800/40 disabled:bg-gray-50/40 dark:text-white disabled:text-gray-400 focus:ring-2 focus:ring-green-500/20 dark:focus:border-green-500 dark:disabled:bg-gray-800/50"
