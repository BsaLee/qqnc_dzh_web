...
<template>
  <div ref="containerRef" class="flex flex-col gap-1.5">
    ...
    <div class="relative">
      <!-- Trigger -->
      <div
        class="w-full flex cursor-pointer items-center justify-between border border-gray-200 rounded-lg bg-white/40 backdrop-blur-md px-3 py-2 outline-none transition-all duration-200 dark:border-gray-700 dark:bg-gray-800/40 dark:text-white"
        :class="{
          'bg-gray-50/40 text-gray-400 cursor-not-allowed dark:bg-gray-800/50': disabled,
      ...
      >
        <div
          v-if="isOpen"
          class="absolute left-0 right-0 z-50 mt-1 max-h-60 overflow-auto border border-gray-200 rounded-lg bg-white/70 backdrop-blur-md py-1 shadow-lg dark:border-gray-700 dark:bg-gray-800/70"
        >
