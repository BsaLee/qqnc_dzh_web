...
import { formatGrowTime } from '@/utils/format'
...
<template>
  <div class="p-4">
    ...
    <div v-else-if="list.length === 0" class="rounded-lg bg-white/40 backdrop-blur-md p-8 text-center text-gray-500 shadow dark:bg-gray-800/40">
      暂无数据
    </div>
    ...
    <div v-else class="space-y-4">
      ...
      <div class="block sm:hidden space-y-4">
        <div v-for="(item, idx) in list" :key="idx" class="border border-gray-200 rounded-lg bg-white/40 backdrop-blur-md p-4 shadow dark:border-gray-700 dark:bg-gray-800/40">
      ...
      <!-- Desktop Table View -->
      <div class="hidden overflow-hidden border border-gray-200 rounded-lg bg-white/40 backdrop-blur-md shadow sm:block dark:border-gray-700 dark:bg-gray-800/40">
        <div class="overflow-x-auto">
          <table class="w-full whitespace-nowrap text-left text-sm">
            <thead class="border-b bg-gray-50/40 text-xs text-gray-500 uppercase dark:border-gray-700 dark:bg-gray-700/50 dark:text-gray-400">
              <tr>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
              <tr v-for="(item, idx) in list" :key="idx" class="group transition-colors hover:bg-gray-50/40 dark:hover:bg-gray-700/50">
                <td class="sticky left-0 bg-white/40 backdrop-blur-md px-4 py-2 shadow-[1px_0_0_0_rgba(0,0,0,0.05)] transition-colors dark:bg-gray-800/40 group-hover:bg-gray-50/40 dark:shadow-[1px_0_0_0_rgba(255,255,255,0.05)] dark:group-hover:bg-gray-700/50">
